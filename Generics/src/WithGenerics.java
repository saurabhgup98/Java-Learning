...
public class WithGenerics {
    public static void main(String[] args) {
        CustomArrayListG<Integer> obj = new CustomArrayListG<>();
        obj.add(1);
        obj.add(2);
        obj.add(3);
        obj.add(4);
        obj.add(5);
        obj.add(6);
//        obj.add("Seven"); // Not allowed as in Generics we specified the type as Integer
        obj.add(7);
